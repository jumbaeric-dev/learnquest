...
class UniverseDashboardService
{
    ...
    {
        $mission = $this->learningJourney
            ->getCurrentMission($child);
    ...
    public function explorerHeader(Child $child): ?ExplorerHeaderDTO
    {
        ...
        $xpIntoLevel = $child->xp % 100;

        $percentage = (int) round(($xpIntoLevel / 100) * 100);
    ...
    public function continueLearning(
        ...
        $course = $this->learningJourney
            ->getCurrentCourse($child);

        $lesson = $this->learningJourney
    ...
    public function recommendedAdventures(
        Child $child,
    ): array {

        $currentCourse = $this->learningJourney
            ->getCurrentCourse($child);
